...
class CNN(object):
    ...
    def step(self, x, y, epoch=0, iteration=0, train=False):
        ...
        if(train):
            ...
            if(epoch > 5): epoch = 5
            tmp_lr = (epoch * self.learning_rate) / 5

            optimizer = tf.optimizers.SGD(learning_rate=tmp_lr, nesterov=True)
            ...
            with self.summary_writer.as_default():
                ...
                tf.summary.scalar('ResNet/learning_rate', tmp_lr, step=iteration)
